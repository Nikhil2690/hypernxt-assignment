    ...
    <footer className="bg-white border-t" style={{ minHeight: '60vh' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-5 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li><a href="#" className="hover:text-gray-900">Our Journals</a></li>
              <li><a href="#" className="hover:text-gray-900">Careers</a></li>
              <li><a href="#" className="hover:text-gray-900">Affiliate Programme</a></li>
              <li><a href="#" className="hover:text-gray-900">Ultras Press</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-600">
              ...
              <li><a href="#" className="hover:text-gray-900">Cookie Guidelines</a></li>
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 mb-4">Subscribe to our newsletter to get updates about our grand offers.</p>
            <input 
              type="email" 
        ...
        <div className="border-t pt-8 flex justify-between items-center text-sm text-gray-600">
          ...
          <p>Designed By <a href="#" className="underline hover:text-gray-900">Hypernxt</a></p>
        </div>
      </div>
    </footer>
  );
